...
void fp4_batched_quantize(Tensor self, Optional<Tensor> const& mask, Tensor globalScale, Tensor valueE2M1, Tensor scaleFP8SF,
...
void silu_and_mul_fp4_batched_quantize(Tensor const& self,
                                        Tensor const& mask,
                                        Tensor const& globalScale,
                                        Tensor valueE2M1, Tensor scaleFP8SF,
                                        int64_t sfVecSize) {
